...
while True:
        ...
        cnts1,_ = cv2.findContours(mask1, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
        #cnts1 = imutils.grab_contours(cnts1)
        cnts2,_ = cv2.findContours(mask2,cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
        cnts3,_ = cv2.findContours(mask3,cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
        cnts4,_ = cv2.findContours(mask4,cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
